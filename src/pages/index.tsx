        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <form className="mt-8 space-y-6">
            ...
            <div className="grid w-full md:grid-cols-2 justify-items-center">
              <button type="button" className="text-white bg-[#393939] hover:bg-[#393939]/90 focus:ring-4 focus:outline-none focus:ring-[#393939]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-500 dark:hover:bg-[#000000] mr-2 mb-2" onClick={handleSignInGitHub}>
              ...
              <button type="button" className="text-white bg-[#4285F4] hover:bg-[#4285F4]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 mr-2 mb-2" onClick={handleSignInGoogle}>
